...
### Schema Details
Clicking on a schema opens its detail page, where you can inspect the schema definition and review schema versions.

![Schema detail page](../../../assets/danube_ui/schema_details.png)
